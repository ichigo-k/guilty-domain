...
function FeaturedProducts() {
  return (
    <div className='contain w-full bg-gray-100'>
      <div className='w-full flex gap-x-4 p-4 max-md:overflow-x-auto snap-x snap-mandatory no-scrollbar'>
        <div className="snap-start flex-shrink-0 w-1/3 max-md:w-[80%] shadow-md rounded-md bg-white mt-5 relative">
